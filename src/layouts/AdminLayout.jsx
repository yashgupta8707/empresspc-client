...
import { Zap } from "lucide-react"; // Fixed import - add curly braces
...
export default function AdminLayout({ children }) {
  ...
  const navigation = [
    ...
    },
    {
      name: "Deals",
      href: "/admin/deals",
      icon: <Zap className="w-5 h-5" />, // Fixed usage - wrap in JSX element with proper className
    },
    {
      name: "About Page",
      href: "/admin/about",
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      >
        ...
        <div
          className={`relative flex-1 flex flex-col max-w-xs w-full bg-white transition-transform transform ${
        ...
        >
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <h1 className="text-2xl font-bold text-red-500">Empress Admin</h1>
            </div>

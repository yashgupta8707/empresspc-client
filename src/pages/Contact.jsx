        ...
        <div className="flex-1 grid md:grid-cols-2 gap-6 md:gap-16 items-center">
          <div className="space-y-6">
            <div>
              ...
              <p className="mb-1">+91-88811-23433</p>
              <p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  className="bg-transparent border border-orange-500 rounded-md px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-400"
              ...
              <input
                ...
                required
                placeholder="Email *"
                className="w-full bg-transparent border border-orange-500 rounded-md px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-400"
                onChange={handleChange}
                disabled={loading}
              />
              ...
              <textarea
                ...
                className="w-full bg-transparent border border-orange-500 rounded-md px-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-400 resize-vertical"
                onChange={handleChange}
                disabled={loading}
              ></textarea>
